	...
	<div class="container">
		<div class="row">
			...
			<form action="<%=contextPath %>/orderInsertForm.my" id="goOrderForm" method="post">
				...
				<!-- 장바구니 담기 -->
				<p>
				<input type="submit" class="btn btn-black py-3 px-5" value="주문하기">
					&nbsp;&nbsp;&nbsp;
				<input type="submit" class="btn" value="💗" formaction="<%=contextPath %>/CartInsert.pd">
				</p>
				</form>
			</div>
			<!-- END 상품 내용 -->
